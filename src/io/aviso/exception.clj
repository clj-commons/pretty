...
(defn write-exception
  ...
  [expand-stack-trace](#var-expand-stack-trace).
  ...
  * `:omit` -replaces the frame with a \"...\" placeholder; multiple consecutive `:omit`s will be collapsed to a single line.
...
(defn format-exception
  "Formats an exception as a multi-line string using [write-exception][#var-write-exception]."
  ([exception]
